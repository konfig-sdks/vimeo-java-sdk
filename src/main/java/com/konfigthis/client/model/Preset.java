...
public class Preset {
  ...
  public Preset metadata(PresetMetadata metadata) {
  ...
  **/
  ...
  public void setMetadata(PresetMetadata metadata) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Minimalism", required = true, value = "The display name of the preset group.")
  ...
  public Preset settings(PresetSettings settings) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "/users/152184/presets/12345", required = true, value = "The canonical relative URI of the preset object.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The owner of the preset.")
   ...
   * @return the Preset instance itself
   */
  public Preset putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.metadata, preset.metadata) &&
        Objects.equals(this.name, preset.name) &&
        Objects.equals(this.settings, preset.settings) &&
        Objects.equals(this.uri, preset.uri) &&
        Objects.equals(this.user, preset.user)&&
        Objects.equals(this.additionalProperties, preset.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(metadata, name, settings, uri, user, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Preset
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Preset.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      PresetMetadata.validateJsonObject(jsonObj.getAsJsonObject("metadata"));
      if (!jsonObj.get("name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("name").toString()));
      }
      // validate the required field `settings`
      PresetSettings.validateJsonObject(jsonObj.getAsJsonObject("settings"));
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Preset>() {
           ...
           public Preset read(JsonReader in) throws IOException {
             ...
             Preset instance = thisAdapter.fromJsonTree(jsonObj);
