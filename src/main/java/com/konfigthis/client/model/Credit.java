...
public class Credit {
  ...
  **/
  ...
  @ApiModelProperty(example = "Sam Doe", required = true, value = "The name of the person credited.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Themselves", required = true, value = "The character that the person portrayed, or the job that the person performed.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "/videos/258684937/credits/1234", required = true, value = "The unique identifier to access the credit resource.")
  ...
  **/
  ...
  @ApiModelProperty(value = "The Vimeo user associated with the credit.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The video associated with the credit.")
   ...
   * @return the Credit instance itself
   */
  public Credit putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, credit.name) &&
        ...
        Objects.equals(this.additionalProperties, credit.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, role, uri, user, video, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Credit>() {
           ...
           public Credit read(JsonReader in) throws IOException {
             ...
             Credit instance = thisAdapter.fromJsonTree(jsonObj);
