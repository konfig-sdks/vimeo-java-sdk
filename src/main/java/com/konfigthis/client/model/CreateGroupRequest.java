...
public class CreateGroupRequest {
  ...
  **/
  ...
  @ApiModelProperty(example = "Want to participate in our weekly challenges? Join the group to receive messages and new challenges!", value = "The description of the group.")
  ...
  **/
  ...
  @ApiModelProperty(example = "Vimeo Weekend Challenge", required = true, value = "The name of the group.")
   ...
   * @return the CreateGroupRequest instance itself
   */
