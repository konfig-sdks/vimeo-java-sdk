...
public class EmailCaptureFormCustomFieldsInner {
  ...
  private List<EmailCaptureFormCustomFieldsInnerConnectedFieldsInner> connectedFields = new ArrayList<>();
 ...
 public enum FieldTypeEnum {
  ...
  public EmailCaptureFormCustomFieldsInner() {
  }

  public EmailCaptureFormCustomFieldsInner connectedFields(List<EmailCaptureFormCustomFieldsInnerConnectedFieldsInner> connectedFields) {
  ...
  public EmailCaptureFormCustomFieldsInner addConnectedFieldsItem(EmailCaptureFormCustomFieldsInnerConnectedFieldsInner connectedFieldsItem) {
  ...
  **/
  ...
  public List<EmailCaptureFormCustomFieldsInnerConnectedFieldsInner> getConnectedFields() {
    return connectedFields;
  }


  public void setConnectedFields(List<EmailCaptureFormCustomFieldsInnerConnectedFieldsInner> connectedFields) {
  ...
  public EmailCaptureFormCustomFieldsInner fieldMetadata(EmailCaptureFormCustomFieldsInnerFieldMetadata fieldMetadata) {
  ...
  **/
  ...
  public EmailCaptureFormCustomFieldsInner fieldName(String fieldName) {
  ...
  **/
  ...
  public EmailCaptureFormCustomFieldsInner fieldType(FieldTypeEnum fieldType) {
  ...
  **/
  ...
  public EmailCaptureFormCustomFieldsInner locked(Boolean locked) {
  ...
  **/
  ...
  public EmailCaptureFormCustomFieldsInner required(Boolean required) {
  ...
  **/
  ...
  public EmailCaptureFormCustomFieldsInner staticField(Boolean staticField) {
  ...
  **/
   ...
   * @return the EmailCaptureFormCustomFieldsInner instance itself
   */
  public EmailCaptureFormCustomFieldsInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmailCaptureFormCustomFieldsInner emailCaptureFormCustomFieldsInner = (EmailCaptureFormCustomFieldsInner) o;
    return Objects.equals(this.connectedFields, emailCaptureFormCustomFieldsInner.connectedFields) &&
        Objects.equals(this.fieldMetadata, emailCaptureFormCustomFieldsInner.fieldMetadata) &&
        Objects.equals(this.fieldName, emailCaptureFormCustomFieldsInner.fieldName) &&
        Objects.equals(this.fieldType, emailCaptureFormCustomFieldsInner.fieldType) &&
        Objects.equals(this.locked, emailCaptureFormCustomFieldsInner.locked) &&
        Objects.equals(this.required, emailCaptureFormCustomFieldsInner.required) &&
        Objects.equals(this.staticField, emailCaptureFormCustomFieldsInner.staticField)&&
        Objects.equals(this.additionalProperties, emailCaptureFormCustomFieldsInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmailCaptureFormCustomFieldsInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmailCaptureFormCustomFieldsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmailCaptureFormCustomFieldsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmailCaptureFormCustomFieldsInner is not found in the empty JSON string", EmailCaptureFormCustomFieldsInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmailCaptureFormCustomFieldsInner.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayconnectedFields.size(); i++) {
        EmailCaptureFormCustomFieldsInnerConnectedFieldsInner.validateJsonObject(jsonArrayconnectedFields.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmailCaptureFormCustomFieldsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmailCaptureFormCustomFieldsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmailCaptureFormCustomFieldsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmailCaptureFormCustomFieldsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<EmailCaptureFormCustomFieldsInner>() {
           @Override
           public void write(JsonWriter out, EmailCaptureFormCustomFieldsInner value) throws IOException {
           ...
           @Override
           public EmailCaptureFormCustomFieldsInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmailCaptureFormCustomFieldsInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmailCaptureFormCustomFieldsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmailCaptureFormCustomFieldsInner
  * @throws IOException if the JSON string is invalid with respect to EmailCaptureFormCustomFieldsInner
  */
  public static EmailCaptureFormCustomFieldsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmailCaptureFormCustomFieldsInner.class);
  }

 /**
  * Convert an instance of EmailCaptureFormCustomFieldsInner to an JSON string
  *
  * @return JSON string
  */
