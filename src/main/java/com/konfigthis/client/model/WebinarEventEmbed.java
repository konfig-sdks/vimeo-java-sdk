...
import com.konfigthis.client.model.WebinarEventEmbedColors;
import com.konfigthis.client.model.WebinarEventEmbedLogos;
...
public class WebinarEventEmbed {
  ...
  private WebinarEventEmbedColors colors;
  ...
  private WebinarEventEmbedLogos logos;
 ...
 public enum PlayButtonPositionEnum {
  ...
  public WebinarEventEmbed() {
  }

  public WebinarEventEmbed title(Boolean title) {
  ...
  **/
  ...
  public WebinarEventEmbed airplay(Boolean airplay) {
  ...
  **/
  ...
  public WebinarEventEmbed autoplay(Boolean autoplay) {
  ...
  **/
  ...
  public WebinarEventEmbed availablePlayerLogos(List<String> availablePlayerLogos) {
  ...
  public WebinarEventEmbed addAvailablePlayerLogosItem(String availablePlayerLogosItem) {
  ...
  **/
  ...
  public WebinarEventEmbed byline(Boolean byline) {
  ...
  **/
  ...
  public WebinarEventEmbed chatEmbedSource(String chatEmbedSource) {
  ...
  **/
  ...
  public WebinarEventEmbed chromecast(Boolean chromecast) {
  ...
  **/
  ...
  public WebinarEventEmbed closedCaptions(Boolean closedCaptions) {
  ...
  **/
  ...
  public WebinarEventEmbed color(String color) {
  ...
  **/
  ...
  public WebinarEventEmbed colors(WebinarEventEmbedColors colors) {
  ...
  **/
  ...
  public WebinarEventEmbedColors getColors() {
    return colors;
  }


  public void setColors(WebinarEventEmbedColors colors) {
  ...
  public WebinarEventEmbed embedChat(String embedChat) {
  ...
  **/
  ...
  public WebinarEventEmbed embedProperties(LiveEventEmbedEmbedProperties embedProperties) {
  ...
  **/
  ...
  public WebinarEventEmbed eventSchedule(Boolean eventSchedule) {
  ...
  **/
  ...
  public WebinarEventEmbed fullscreenButton(Boolean fullscreenButton) {
  ...
  **/
  ...
  public WebinarEventEmbed hideLiveLabel(Boolean hideLiveLabel) {
  ...
  **/
  ...
  public WebinarEventEmbed hideViewerCount(Boolean hideViewerCount) {
  ...
  **/
  ...
  public WebinarEventEmbed html(String html) {
  ...
  **/
  ...
  public WebinarEventEmbed likeButton(Boolean likeButton) {
  ...
  **/
  ...
  public WebinarEventEmbed logos(WebinarEventEmbedLogos logos) {
  ...
  **/
  ...
  public WebinarEventEmbedLogos getLogos() {
    return logos;
  }


  public void setLogos(WebinarEventEmbedLogos logos) {
  ...
  public WebinarEventEmbed loop(Boolean loop) {
  ...
  **/
  ...
  public WebinarEventEmbed pip(Boolean pip) {
  ...
  **/
  ...
  public WebinarEventEmbed playButtonPosition(PlayButtonPositionEnum playButtonPosition) {
  ...
  **/
  ...
  public WebinarEventEmbed playbar(Boolean playbar) {
  ...
  **/
  ...
  public WebinarEventEmbed playlist(Boolean playlist) {
  ...
  **/
  ...
  public WebinarEventEmbed portrait(Boolean portrait) {
  ...
  **/
  ...
  public WebinarEventEmbed responsiveHtml(String responsiveHtml) {
  ...
  **/
  ...
  public WebinarEventEmbed schedule(Boolean schedule) {
  ...
  **/
  ...
  public WebinarEventEmbed showLatestArchivedClip(Boolean showLatestArchivedClip) {
  ...
  **/
  ...
  public WebinarEventEmbed showTimezone(Boolean showTimezone) {
  ...
  **/
  ...
  public WebinarEventEmbed useColor(String useColor) {
  ...
  **/
  ...
  public WebinarEventEmbed volume(Boolean volume) {
  ...
  **/
   ...
   * @return the WebinarEventEmbed instance itself
   */
  public WebinarEventEmbed putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WebinarEventEmbed webinarEventEmbed = (WebinarEventEmbed) o;
    return Objects.equals(this.title, webinarEventEmbed.title) &&
        Objects.equals(this.airplay, webinarEventEmbed.airplay) &&
        Objects.equals(this.autoplay, webinarEventEmbed.autoplay) &&
        Objects.equals(this.availablePlayerLogos, webinarEventEmbed.availablePlayerLogos) &&
        Objects.equals(this.byline, webinarEventEmbed.byline) &&
        Objects.equals(this.chatEmbedSource, webinarEventEmbed.chatEmbedSource) &&
        Objects.equals(this.chromecast, webinarEventEmbed.chromecast) &&
        Objects.equals(this.closedCaptions, webinarEventEmbed.closedCaptions) &&
        Objects.equals(this.color, webinarEventEmbed.color) &&
        Objects.equals(this.colors, webinarEventEmbed.colors) &&
        Objects.equals(this.embedChat, webinarEventEmbed.embedChat) &&
        Objects.equals(this.embedProperties, webinarEventEmbed.embedProperties) &&
        Objects.equals(this.eventSchedule, webinarEventEmbed.eventSchedule) &&
        Objects.equals(this.fullscreenButton, webinarEventEmbed.fullscreenButton) &&
        Objects.equals(this.hideLiveLabel, webinarEventEmbed.hideLiveLabel) &&
        Objects.equals(this.hideViewerCount, webinarEventEmbed.hideViewerCount) &&
        Objects.equals(this.html, webinarEventEmbed.html) &&
        Objects.equals(this.likeButton, webinarEventEmbed.likeButton) &&
        Objects.equals(this.logos, webinarEventEmbed.logos) &&
        Objects.equals(this.loop, webinarEventEmbed.loop) &&
        Objects.equals(this.pip, webinarEventEmbed.pip) &&
        Objects.equals(this.playButtonPosition, webinarEventEmbed.playButtonPosition) &&
        Objects.equals(this.playbar, webinarEventEmbed.playbar) &&
        Objects.equals(this.playlist, webinarEventEmbed.playlist) &&
        Objects.equals(this.portrait, webinarEventEmbed.portrait) &&
        Objects.equals(this.responsiveHtml, webinarEventEmbed.responsiveHtml) &&
        Objects.equals(this.schedule, webinarEventEmbed.schedule) &&
        Objects.equals(this.showLatestArchivedClip, webinarEventEmbed.showLatestArchivedClip) &&
        Objects.equals(this.showTimezone, webinarEventEmbed.showTimezone) &&
        Objects.equals(this.useColor, webinarEventEmbed.useColor) &&
        Objects.equals(this.volume, webinarEventEmbed.volume)&&
        Objects.equals(this.additionalProperties, webinarEventEmbed.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebinarEventEmbed {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebinarEventEmbed
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebinarEventEmbed.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebinarEventEmbed is not found in the empty JSON string", WebinarEventEmbed.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebinarEventEmbed.openapiRequiredFields) {
      ...
      WebinarEventEmbedColors.validateJsonObject(jsonObj.getAsJsonObject("colors"));
      ...
      WebinarEventEmbedLogos.validateJsonObject(jsonObj.getAsJsonObject("logos"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebinarEventEmbed.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebinarEventEmbed' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebinarEventEmbed> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebinarEventEmbed.class));

       return (TypeAdapter<T>) new TypeAdapter<WebinarEventEmbed>() {
           @Override
           public void write(JsonWriter out, WebinarEventEmbed value) throws IOException {
           ...
           @Override
           public WebinarEventEmbed read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WebinarEventEmbed instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WebinarEventEmbed given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebinarEventEmbed
  * @throws IOException if the JSON string is invalid with respect to WebinarEventEmbed
  */
  public static WebinarEventEmbed fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebinarEventEmbed.class);
  }

 /**
  * Convert an instance of WebinarEventEmbed to an JSON string
  *
  * @return JSON string
  */
