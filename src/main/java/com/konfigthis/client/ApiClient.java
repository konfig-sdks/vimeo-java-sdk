...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://api.vimeo.com";
    private String tokenUrl = "/oauth/authorize/client";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.vimeo.com)
     ...
     * Set token url
     *
     * @param tokenUrl Token URL for oauth (e.g /oauth/authorize/client)
     * @return An instance of OkHttpClient
     */
