...
public class ApiApp {
  ...
  public ApiApp capabilities(Object capabilities) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The app's capabilities list.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Vimeo Android", required = true, value = "The name of the API app.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "/apps/12345", required = true, value = "The canonical URI of the API app.")
   ...
   * @return the ApiApp instance itself
   */
  public ApiApp putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.capabilities, apiApp.capabilities) &&
        Objects.equals(this.name, apiApp.name) &&
        Objects.equals(this.uri, apiApp.uri)&&
        Objects.equals(this.additionalProperties, apiApp.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(capabilities, name, uri, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ApiApp>() {
           ...
           public ApiApp read(JsonReader in) throws IOException {
             ...
             ApiApp instance = thisAdapter.fromJsonTree(jsonObj);
