...
public class LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest {
 ...
 public enum TypeEnum {
  ...
  public LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest() {
  }

  public LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest displayName(String displayName) {
  ...
  **/
  ...
  public LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest isEnabled(Boolean isEnabled) {
  ...
  **/
  ...
  public LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest privacy(PrivacyEnum privacy) {
  ...
  **/
  ...
  public LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest providerDestinationId(String providerDestinationId) {
  ...
  **/
  ...
  public LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest providerVideoId(String providerVideoId) {
  ...
  **/
  ...
  public LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest scheduledAt(Double scheduledAt) {
  ...
  public LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest scheduledAt(Integer scheduledAt) {
  ...
  **/
  ...
  public LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest serviceName(ServiceNameEnum serviceName) {
  ...
  **/
  ...
  public LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest streamKey(String streamKey) {
  ...
  **/
  ...
  public LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest streamUrl(String streamUrl) {
  ...
  **/
  ...
  public LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest type(TypeEnum type) {
  ...
  **/
   ...
   * @return the LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest instance itself
   */
  public LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest liveEventDestinationsCreateOneTimeLiveEventDestinationRequest = (LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest) o;
    return Objects.equals(this.displayName, liveEventDestinationsCreateOneTimeLiveEventDestinationRequest.displayName) &&
        Objects.equals(this.isEnabled, liveEventDestinationsCreateOneTimeLiveEventDestinationRequest.isEnabled) &&
        Objects.equals(this.privacy, liveEventDestinationsCreateOneTimeLiveEventDestinationRequest.privacy) &&
        Objects.equals(this.providerDestinationId, liveEventDestinationsCreateOneTimeLiveEventDestinationRequest.providerDestinationId) &&
        Objects.equals(this.providerVideoId, liveEventDestinationsCreateOneTimeLiveEventDestinationRequest.providerVideoId) &&
        Objects.equals(this.scheduledAt, liveEventDestinationsCreateOneTimeLiveEventDestinationRequest.scheduledAt) &&
        Objects.equals(this.serviceName, liveEventDestinationsCreateOneTimeLiveEventDestinationRequest.serviceName) &&
        Objects.equals(this.streamKey, liveEventDestinationsCreateOneTimeLiveEventDestinationRequest.streamKey) &&
        Objects.equals(this.streamUrl, liveEventDestinationsCreateOneTimeLiveEventDestinationRequest.streamUrl) &&
        Objects.equals(this.type, liveEventDestinationsCreateOneTimeLiveEventDestinationRequest.type)&&
        Objects.equals(this.additionalProperties, liveEventDestinationsCreateOneTimeLiveEventDestinationRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest is not found in the empty JSON string", LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest>() {
           @Override
           public void write(JsonWriter out, LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest value) throws IOException {
           ...
           @Override
           public LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest
  * @throws IOException if the JSON string is invalid with respect to LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest
  */
  public static LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest.class);
  }

 /**
  * Convert an instance of LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest to an JSON string
  *
  * @return JSON string
  */
