...
public class Language {
  ...
  **/
  ...
  @ApiModelProperty(example = "en-US", required = true, value = "The standard ISO 639-1 code for the language.")
  ...
  **/
   ...
   * @return the Language instance itself
   */
  public Language putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, language.code) &&
        ...
        Objects.equals(this.additionalProperties, language.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Language.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Language>() {
           ...
           public Language read(JsonReader in) throws IOException {
             ...
             Language instance = thisAdapter.fromJsonTree(jsonObj);
