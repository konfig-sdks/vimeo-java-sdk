...
public class ContentRating {
  ...
  **/
  ...
  @ApiModelProperty(example = "VIOLENCE", required = true, value = "The reason for the content rating.  Option descriptions:  * `advertisement` - The content contains an advertisement.  * `drugs` - The content contains drug or alcohol use.  * `language` - The content contains profanity or sexually suggestive language.  * `nudity` - The content contains nudity.  * `safe` - The content is suitable for all audiences.  * `unrated` - The content hasn't been rated.  * `violence` - The content contains violence or is graphic. ")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Violence", required = true, value = "The name of the content rating.")
  ...
  **/
  ...
  @ApiModelProperty(example = "/contentrating/violence", required = true, value = "The canonical relative URI of the content rating.")
   ...
   * @return the ContentRating instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, contentRating.code) &&
        ...
        Objects.equals(this.additionalProperties, contentRating.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, name, uri, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContentRating
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContentRating.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ContentRating>() {
           ...
           public ContentRating read(JsonReader in) throws IOException {
             ...
             ContentRating instance = thisAdapter.fromJsonTree(jsonObj);
