...
public class OnDemandEssentialsCreatePageRequest {
 ...
 public enum TypeEnum {
  ...
  public OnDemandEssentialsCreatePageRequest() {
  }

  public OnDemandEssentialsCreatePageRequest description(String description) {
  ...
  **/
  ...
  public OnDemandEssentialsCreatePageRequest acceptedCurrencies(AcceptedCurrenciesEnum acceptedCurrencies) {
  ...
  **/
  ...
  public OnDemandEssentialsCreatePageRequest buy(OnDemandEssentialsCreatePageRequestBuy buy) {
  ...
  **/
  ...
  public OnDemandEssentialsCreatePageRequestBuy getBuy() {
    return buy;
  }


  public void setBuy(OnDemandEssentialsCreatePageRequestBuy buy) {
  ...
  public OnDemandEssentialsCreatePageRequest contentRating(ContentRatingEnum contentRating) {
  ...
  **/
  ...
  public OnDemandEssentialsCreatePageRequest domainLink(String domainLink) {
  ...
  **/
  ...
  public OnDemandEssentialsCreatePageRequest episodes(OnDemandEssentialsCreatePageRequestEpisodes episodes) {
  ...
  **/
  ...
  public OnDemandEssentialsCreatePageRequestEpisodes getEpisodes() {
    return episodes;
  }


  public void setEpisodes(OnDemandEssentialsCreatePageRequestEpisodes episodes) {
  ...
  public OnDemandEssentialsCreatePageRequest link(String link) {
  ...
  **/
  ...
  public OnDemandEssentialsCreatePageRequest name(String name) {
  ...
  **/
  ...
  public OnDemandEssentialsCreatePageRequest rent(OnDemandEssentialsCreatePageRequestRent rent) {
  ...
  **/
  ...
  public OnDemandEssentialsCreatePageRequestRent getRent() {
    return rent;
  }


  public void setRent(OnDemandEssentialsCreatePageRequestRent rent) {
  ...
  public OnDemandEssentialsCreatePageRequest subscription(OnDemandEssentialsCreatePageRequestSubscription subscription) {
  ...
  **/
  ...
  public OnDemandEssentialsCreatePageRequestSubscription getSubscription() {
    return subscription;
  }


  public void setSubscription(OnDemandEssentialsCreatePageRequestSubscription subscription) {
  ...
  public OnDemandEssentialsCreatePageRequest type(TypeEnum type) {
  ...
  **/
   ...
   * @return the OnDemandEssentialsCreatePageRequest instance itself
   */
  public OnDemandEssentialsCreatePageRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OnDemandEssentialsCreatePageRequest onDemandEssentialsCreatePageRequest = (OnDemandEssentialsCreatePageRequest) o;
    return Objects.equals(this.description, onDemandEssentialsCreatePageRequest.description) &&
        Objects.equals(this.acceptedCurrencies, onDemandEssentialsCreatePageRequest.acceptedCurrencies) &&
        Objects.equals(this.buy, onDemandEssentialsCreatePageRequest.buy) &&
        Objects.equals(this.contentRating, onDemandEssentialsCreatePageRequest.contentRating) &&
        Objects.equals(this.domainLink, onDemandEssentialsCreatePageRequest.domainLink) &&
        Objects.equals(this.episodes, onDemandEssentialsCreatePageRequest.episodes) &&
        Objects.equals(this.link, onDemandEssentialsCreatePageRequest.link) &&
        Objects.equals(this.name, onDemandEssentialsCreatePageRequest.name) &&
        Objects.equals(this.rent, onDemandEssentialsCreatePageRequest.rent) &&
        Objects.equals(this.subscription, onDemandEssentialsCreatePageRequest.subscription) &&
        Objects.equals(this.type, onDemandEssentialsCreatePageRequest.type)&&
        Objects.equals(this.additionalProperties, onDemandEssentialsCreatePageRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OnDemandEssentialsCreatePageRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OnDemandEssentialsCreatePageRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OnDemandEssentialsCreatePageRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OnDemandEssentialsCreatePageRequest is not found in the empty JSON string", OnDemandEssentialsCreatePageRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OnDemandEssentialsCreatePageRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("buy") != null && !jsonObj.get("buy").isJsonNull()) {
        OnDemandEssentialsCreatePageRequestBuy.validateJsonObject(jsonObj.getAsJsonObject("buy"));
      }
      ...
      if (jsonObj.get("episodes") != null && !jsonObj.get("episodes").isJsonNull()) {
        OnDemandEssentialsCreatePageRequestEpisodes.validateJsonObject(jsonObj.getAsJsonObject("episodes"));
      }
      ...
      if (jsonObj.get("rent") != null && !jsonObj.get("rent").isJsonNull()) {
        OnDemandEssentialsCreatePageRequestRent.validateJsonObject(jsonObj.getAsJsonObject("rent"));
      }
      // validate the optional field `subscription`
      if (jsonObj.get("subscription") != null && !jsonObj.get("subscription").isJsonNull()) {
        OnDemandEssentialsCreatePageRequestSubscription.validateJsonObject(jsonObj.getAsJsonObject("subscription"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OnDemandEssentialsCreatePageRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OnDemandEssentialsCreatePageRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OnDemandEssentialsCreatePageRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OnDemandEssentialsCreatePageRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<OnDemandEssentialsCreatePageRequest>() {
           @Override
           public void write(JsonWriter out, OnDemandEssentialsCreatePageRequest value) throws IOException {
           ...
           @Override
           public OnDemandEssentialsCreatePageRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OnDemandEssentialsCreatePageRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OnDemandEssentialsCreatePageRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OnDemandEssentialsCreatePageRequest
  * @throws IOException if the JSON string is invalid with respect to OnDemandEssentialsCreatePageRequest
  */
  public static OnDemandEssentialsCreatePageRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OnDemandEssentialsCreatePageRequest.class);
  }

 /**
  * Convert an instance of OnDemandEssentialsCreatePageRequest to an JSON string
  *
  * @return JSON string
  */
