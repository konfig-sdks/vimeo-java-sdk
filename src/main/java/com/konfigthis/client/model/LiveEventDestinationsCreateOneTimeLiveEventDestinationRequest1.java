...
public class LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1 {
 ...
 public enum TypeEnum {
  ...
  public LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1() {
  }

  public LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1 displayName(String displayName) {
  ...
  **/
  ...
  public LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1 isEnabled(Boolean isEnabled) {
  ...
  **/
  ...
  public LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1 privacy(PrivacyEnum privacy) {
  ...
  **/
  ...
  public LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1 providerDestinationId(String providerDestinationId) {
  ...
  **/
  ...
  public LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1 providerVideoId(String providerVideoId) {
  ...
  **/
  ...
  public LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1 scheduledAt(Double scheduledAt) {
  ...
  public LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1 scheduledAt(Integer scheduledAt) {
  ...
  **/
  ...
  public LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1 serviceName(ServiceNameEnum serviceName) {
  ...
  **/
  ...
  public LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1 streamKey(String streamKey) {
  ...
  **/
  ...
  public LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1 streamUrl(String streamUrl) {
  ...
  **/
  ...
  public LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1 type(TypeEnum type) {
  ...
  **/
   ...
   * @return the LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1 instance itself
   */
  public LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1 liveEventDestinationsCreateOneTimeLiveEventDestinationRequest1 = (LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1) o;
    return Objects.equals(this.displayName, liveEventDestinationsCreateOneTimeLiveEventDestinationRequest1.displayName) &&
        Objects.equals(this.isEnabled, liveEventDestinationsCreateOneTimeLiveEventDestinationRequest1.isEnabled) &&
        Objects.equals(this.privacy, liveEventDestinationsCreateOneTimeLiveEventDestinationRequest1.privacy) &&
        Objects.equals(this.providerDestinationId, liveEventDestinationsCreateOneTimeLiveEventDestinationRequest1.providerDestinationId) &&
        Objects.equals(this.providerVideoId, liveEventDestinationsCreateOneTimeLiveEventDestinationRequest1.providerVideoId) &&
        Objects.equals(this.scheduledAt, liveEventDestinationsCreateOneTimeLiveEventDestinationRequest1.scheduledAt) &&
        Objects.equals(this.serviceName, liveEventDestinationsCreateOneTimeLiveEventDestinationRequest1.serviceName) &&
        Objects.equals(this.streamKey, liveEventDestinationsCreateOneTimeLiveEventDestinationRequest1.streamKey) &&
        Objects.equals(this.streamUrl, liveEventDestinationsCreateOneTimeLiveEventDestinationRequest1.streamUrl) &&
        Objects.equals(this.type, liveEventDestinationsCreateOneTimeLiveEventDestinationRequest1.type)&&
        Objects.equals(this.additionalProperties, liveEventDestinationsCreateOneTimeLiveEventDestinationRequest1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1 is not found in the empty JSON string", LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1.class));

       return (TypeAdapter<T>) new TypeAdapter<LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1>() {
           @Override
           public void write(JsonWriter out, LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1 value) throws IOException {
           ...
           @Override
           public LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1
  * @throws IOException if the JSON string is invalid with respect to LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1
  */
  public static LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1.class);
  }

 /**
  * Convert an instance of LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1 to an JSON string
  *
  * @return JSON string
  */
