...
public class LiveEssentialsCreateEventForUserRequest {
 ...
 public enum PlaylistSortEnum {
  ...
  public LiveEssentialsCreateEventForUserRequest() {
  }

  public LiveEssentialsCreateEventForUserRequest title(String title) {
  ...
  **/
  ...
  public LiveEssentialsCreateEventForUserRequest allowShareLink(Boolean allowShareLink) {
  ...
  **/
  ...
  public LiveEssentialsCreateEventForUserRequest autoCcEnabled(Boolean autoCcEnabled) {
  ...
  **/
  ...
  public LiveEssentialsCreateEventForUserRequest autoCcKeywords(String autoCcKeywords) {
  ...
  **/
  ...
  public LiveEssentialsCreateEventForUserRequest autoCcLang(AutoCcLangEnum autoCcLang) {
  ...
  **/
  ...
  public LiveEssentialsCreateEventForUserRequest automaticallyTitleStream(Boolean automaticallyTitleStream) {
  ...
  **/
  ...
  public LiveEssentialsCreateEventForUserRequest chatEnabled(Boolean chatEnabled) {
  ...
  **/
  ...
  public LiveEssentialsCreateEventForUserRequest contentRating(List<String> contentRating) {
  ...
  public LiveEssentialsCreateEventForUserRequest addContentRatingItem(String contentRatingItem) {
  ...
  **/
  ...
  public LiveEssentialsCreateEventForUserRequest dvr(Boolean dvr) {
  ...
  **/
  ...
  public LiveEssentialsCreateEventForUserRequest embed(LiveEssentialsCreateEventForUserRequestEmbed embed) {
  ...
  **/
  ...
  public LiveEssentialsCreateEventForUserRequestEmbed getEmbed() {
    return embed;
  }


  public void setEmbed(LiveEssentialsCreateEventForUserRequestEmbed embed) {
  ...
  public LiveEssentialsCreateEventForUserRequest folderUri(String folderUri) {
  ...
  **/
  ...
  public LiveEssentialsCreateEventForUserRequest interactionToolsSettings(LiveEssentialsCreateEventForUserRequestInteractionToolsSettings interactionToolsSettings) {
  ...
  **/
  ...
  public LiveEssentialsCreateEventForUserRequestInteractionToolsSettings getInteractionToolsSettings() {
    return interactionToolsSettings;
  }


  public void setInteractionToolsSettings(LiveEssentialsCreateEventForUserRequestInteractionToolsSettings interactionToolsSettings) {
  ...
  public LiveEssentialsCreateEventForUserRequest lowLatency(Boolean lowLatency) {
  ...
  **/
  ...
  public LiveEssentialsCreateEventForUserRequest playlistSort(PlaylistSortEnum playlistSort) {
  ...
  **/
  ...
  public LiveEssentialsCreateEventForUserRequest rtmpPreview(Boolean rtmpPreview) {
  ...
  **/
  ...
  public LiveEssentialsCreateEventForUserRequest schedule(LiveEssentialsCreateEventForUserRequestSchedule schedule) {
  ...
  **/
  ...
  public LiveEssentialsCreateEventForUserRequestSchedule getSchedule() {
    return schedule;
  }


  public void setSchedule(LiveEssentialsCreateEventForUserRequestSchedule schedule) {
  ...
  public LiveEssentialsCreateEventForUserRequest scheduledPlayback(Boolean scheduledPlayback) {
  ...
  **/
  ...
  public LiveEssentialsCreateEventForUserRequest streamDescription(String streamDescription) {
  ...
  **/
  ...
  public LiveEssentialsCreateEventForUserRequest streamEmbed(LiveEssentialsCreateEventForUserRequestStreamEmbed streamEmbed) {
  ...
  **/
  ...
  public LiveEssentialsCreateEventForUserRequestStreamEmbed getStreamEmbed() {
    return streamEmbed;
  }


  public void setStreamEmbed(LiveEssentialsCreateEventForUserRequestStreamEmbed streamEmbed) {
  ...
  public LiveEssentialsCreateEventForUserRequest streamPassword(String streamPassword) {
  ...
  **/
  ...
  public LiveEssentialsCreateEventForUserRequest streamPrivacy(LiveEssentialsCreateEventForUserRequestStreamPrivacy streamPrivacy) {
  ...
  **/
  ...
  public LiveEssentialsCreateEventForUserRequestStreamPrivacy getStreamPrivacy() {
    return streamPrivacy;
  }


  public void setStreamPrivacy(LiveEssentialsCreateEventForUserRequestStreamPrivacy streamPrivacy) {
  ...
  public LiveEssentialsCreateEventForUserRequest streamTitle(String streamTitle) {
  ...
  **/
  ...
  public LiveEssentialsCreateEventForUserRequest timeZone(String timeZone) {
  ...
  **/
   ...
   * @return the LiveEssentialsCreateEventForUserRequest instance itself
   */
  public LiveEssentialsCreateEventForUserRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LiveEssentialsCreateEventForUserRequest liveEssentialsCreateEventForUserRequest = (LiveEssentialsCreateEventForUserRequest) o;
    return Objects.equals(this.title, liveEssentialsCreateEventForUserRequest.title) &&
        Objects.equals(this.allowShareLink, liveEssentialsCreateEventForUserRequest.allowShareLink) &&
        Objects.equals(this.autoCcEnabled, liveEssentialsCreateEventForUserRequest.autoCcEnabled) &&
        Objects.equals(this.autoCcKeywords, liveEssentialsCreateEventForUserRequest.autoCcKeywords) &&
        Objects.equals(this.autoCcLang, liveEssentialsCreateEventForUserRequest.autoCcLang) &&
        Objects.equals(this.automaticallyTitleStream, liveEssentialsCreateEventForUserRequest.automaticallyTitleStream) &&
        Objects.equals(this.chatEnabled, liveEssentialsCreateEventForUserRequest.chatEnabled) &&
        Objects.equals(this.contentRating, liveEssentialsCreateEventForUserRequest.contentRating) &&
        Objects.equals(this.dvr, liveEssentialsCreateEventForUserRequest.dvr) &&
        Objects.equals(this.embed, liveEssentialsCreateEventForUserRequest.embed) &&
        Objects.equals(this.folderUri, liveEssentialsCreateEventForUserRequest.folderUri) &&
        Objects.equals(this.interactionToolsSettings, liveEssentialsCreateEventForUserRequest.interactionToolsSettings) &&
        Objects.equals(this.lowLatency, liveEssentialsCreateEventForUserRequest.lowLatency) &&
        Objects.equals(this.playlistSort, liveEssentialsCreateEventForUserRequest.playlistSort) &&
        Objects.equals(this.rtmpPreview, liveEssentialsCreateEventForUserRequest.rtmpPreview) &&
        Objects.equals(this.schedule, liveEssentialsCreateEventForUserRequest.schedule) &&
        Objects.equals(this.scheduledPlayback, liveEssentialsCreateEventForUserRequest.scheduledPlayback) &&
        Objects.equals(this.streamDescription, liveEssentialsCreateEventForUserRequest.streamDescription) &&
        Objects.equals(this.streamEmbed, liveEssentialsCreateEventForUserRequest.streamEmbed) &&
        Objects.equals(this.streamPassword, liveEssentialsCreateEventForUserRequest.streamPassword) &&
        Objects.equals(this.streamPrivacy, liveEssentialsCreateEventForUserRequest.streamPrivacy) &&
        Objects.equals(this.streamTitle, liveEssentialsCreateEventForUserRequest.streamTitle) &&
        Objects.equals(this.timeZone, liveEssentialsCreateEventForUserRequest.timeZone)&&
        Objects.equals(this.additionalProperties, liveEssentialsCreateEventForUserRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LiveEssentialsCreateEventForUserRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LiveEssentialsCreateEventForUserRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LiveEssentialsCreateEventForUserRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LiveEssentialsCreateEventForUserRequest is not found in the empty JSON string", LiveEssentialsCreateEventForUserRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LiveEssentialsCreateEventForUserRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("embed") != null && !jsonObj.get("embed").isJsonNull()) {
        LiveEssentialsCreateEventForUserRequestEmbed.validateJsonObject(jsonObj.getAsJsonObject("embed"));
      }
      ...
      if (jsonObj.get("interaction_tools_settings") != null && !jsonObj.get("interaction_tools_settings").isJsonNull()) {
        LiveEssentialsCreateEventForUserRequestInteractionToolsSettings.validateJsonObject(jsonObj.getAsJsonObject("interaction_tools_settings"));
      }
      ...
      if (jsonObj.get("schedule") != null && !jsonObj.get("schedule").isJsonNull()) {
        LiveEssentialsCreateEventForUserRequestSchedule.validateJsonObject(jsonObj.getAsJsonObject("schedule"));
      }
      ...
      if (jsonObj.get("stream_embed") != null && !jsonObj.get("stream_embed").isJsonNull()) {
        LiveEssentialsCreateEventForUserRequestStreamEmbed.validateJsonObject(jsonObj.getAsJsonObject("stream_embed"));
      }
      ...
      if (jsonObj.get("stream_privacy") != null && !jsonObj.get("stream_privacy").isJsonNull()) {
        LiveEssentialsCreateEventForUserRequestStreamPrivacy.validateJsonObject(jsonObj.getAsJsonObject("stream_privacy"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LiveEssentialsCreateEventForUserRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LiveEssentialsCreateEventForUserRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LiveEssentialsCreateEventForUserRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LiveEssentialsCreateEventForUserRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<LiveEssentialsCreateEventForUserRequest>() {
           @Override
           public void write(JsonWriter out, LiveEssentialsCreateEventForUserRequest value) throws IOException {
           ...
           @Override
           public LiveEssentialsCreateEventForUserRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LiveEssentialsCreateEventForUserRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LiveEssentialsCreateEventForUserRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LiveEssentialsCreateEventForUserRequest
  * @throws IOException if the JSON string is invalid with respect to LiveEssentialsCreateEventForUserRequest
  */
  public static LiveEssentialsCreateEventForUserRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LiveEssentialsCreateEventForUserRequest.class);
  }

 /**
  * Convert an instance of LiveEssentialsCreateEventForUserRequest to an JSON string
  *
  * @return JSON string
  */
