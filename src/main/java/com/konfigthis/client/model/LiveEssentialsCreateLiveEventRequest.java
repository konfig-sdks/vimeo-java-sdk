...
public class LiveEssentialsCreateLiveEventRequest {
 ...
 public enum PlaylistSortEnum {
  ...
  public LiveEssentialsCreateLiveEventRequest() {
  }

  public LiveEssentialsCreateLiveEventRequest title(String title) {
  ...
  **/
  ...
  public LiveEssentialsCreateLiveEventRequest allowShareLink(Boolean allowShareLink) {
  ...
  **/
  ...
  public LiveEssentialsCreateLiveEventRequest autoCcEnabled(Boolean autoCcEnabled) {
  ...
  **/
  ...
  public LiveEssentialsCreateLiveEventRequest autoCcKeywords(String autoCcKeywords) {
  ...
  **/
  ...
  public LiveEssentialsCreateLiveEventRequest autoCcLang(AutoCcLangEnum autoCcLang) {
  ...
  **/
  ...
  public LiveEssentialsCreateLiveEventRequest automaticallyTitleStream(Boolean automaticallyTitleStream) {
  ...
  **/
  ...
  public LiveEssentialsCreateLiveEventRequest chatEnabled(Boolean chatEnabled) {
  ...
  **/
  ...
  public LiveEssentialsCreateLiveEventRequest contentRating(List<String> contentRating) {
  ...
  public LiveEssentialsCreateLiveEventRequest addContentRatingItem(String contentRatingItem) {
  ...
  **/
  ...
  public LiveEssentialsCreateLiveEventRequest dvr(Boolean dvr) {
  ...
  **/
  ...
  public LiveEssentialsCreateLiveEventRequest embed(LiveEssentialsCreateLiveEventRequestEmbed embed) {
  ...
  **/
  ...
  public LiveEssentialsCreateLiveEventRequestEmbed getEmbed() {
    return embed;
  }


  public void setEmbed(LiveEssentialsCreateLiveEventRequestEmbed embed) {
  ...
  public LiveEssentialsCreateLiveEventRequest folderUri(String folderUri) {
  ...
  **/
  ...
  public LiveEssentialsCreateLiveEventRequest interactionToolsSettings(LiveEssentialsCreateLiveEventRequestInteractionToolsSettings interactionToolsSettings) {
  ...
  **/
  ...
  public LiveEssentialsCreateLiveEventRequestInteractionToolsSettings getInteractionToolsSettings() {
    return interactionToolsSettings;
  }


  public void setInteractionToolsSettings(LiveEssentialsCreateLiveEventRequestInteractionToolsSettings interactionToolsSettings) {
  ...
  public LiveEssentialsCreateLiveEventRequest lowLatency(Boolean lowLatency) {
  ...
  **/
  ...
  public LiveEssentialsCreateLiveEventRequest playlistSort(PlaylistSortEnum playlistSort) {
  ...
  **/
  ...
  public LiveEssentialsCreateLiveEventRequest rtmpPreview(Boolean rtmpPreview) {
  ...
  **/
  ...
  public LiveEssentialsCreateLiveEventRequest schedule(LiveEssentialsCreateLiveEventRequestSchedule schedule) {
  ...
  **/
  ...
  public LiveEssentialsCreateLiveEventRequestSchedule getSchedule() {
    return schedule;
  }


  public void setSchedule(LiveEssentialsCreateLiveEventRequestSchedule schedule) {
  ...
  public LiveEssentialsCreateLiveEventRequest scheduledPlayback(Boolean scheduledPlayback) {
  ...
  **/
  ...
  public LiveEssentialsCreateLiveEventRequest streamDescription(String streamDescription) {
  ...
  **/
  ...
  public LiveEssentialsCreateLiveEventRequest streamEmbed(LiveEssentialsCreateLiveEventRequestStreamEmbed streamEmbed) {
  ...
  **/
  ...
  public LiveEssentialsCreateLiveEventRequestStreamEmbed getStreamEmbed() {
    return streamEmbed;
  }


  public void setStreamEmbed(LiveEssentialsCreateLiveEventRequestStreamEmbed streamEmbed) {
  ...
  public LiveEssentialsCreateLiveEventRequest streamPassword(String streamPassword) {
  ...
  **/
  ...
  public LiveEssentialsCreateLiveEventRequest streamPrivacy(LiveEssentialsCreateLiveEventRequestStreamPrivacy streamPrivacy) {
  ...
  **/
  ...
  public LiveEssentialsCreateLiveEventRequestStreamPrivacy getStreamPrivacy() {
    return streamPrivacy;
  }


  public void setStreamPrivacy(LiveEssentialsCreateLiveEventRequestStreamPrivacy streamPrivacy) {
  ...
  public LiveEssentialsCreateLiveEventRequest streamTitle(String streamTitle) {
  ...
  **/
  ...
  public LiveEssentialsCreateLiveEventRequest timeZone(String timeZone) {
  ...
  **/
   ...
   * @return the LiveEssentialsCreateLiveEventRequest instance itself
   */
  public LiveEssentialsCreateLiveEventRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LiveEssentialsCreateLiveEventRequest liveEssentialsCreateLiveEventRequest = (LiveEssentialsCreateLiveEventRequest) o;
    return Objects.equals(this.title, liveEssentialsCreateLiveEventRequest.title) &&
        Objects.equals(this.allowShareLink, liveEssentialsCreateLiveEventRequest.allowShareLink) &&
        Objects.equals(this.autoCcEnabled, liveEssentialsCreateLiveEventRequest.autoCcEnabled) &&
        Objects.equals(this.autoCcKeywords, liveEssentialsCreateLiveEventRequest.autoCcKeywords) &&
        Objects.equals(this.autoCcLang, liveEssentialsCreateLiveEventRequest.autoCcLang) &&
        Objects.equals(this.automaticallyTitleStream, liveEssentialsCreateLiveEventRequest.automaticallyTitleStream) &&
        Objects.equals(this.chatEnabled, liveEssentialsCreateLiveEventRequest.chatEnabled) &&
        Objects.equals(this.contentRating, liveEssentialsCreateLiveEventRequest.contentRating) &&
        Objects.equals(this.dvr, liveEssentialsCreateLiveEventRequest.dvr) &&
        Objects.equals(this.embed, liveEssentialsCreateLiveEventRequest.embed) &&
        Objects.equals(this.folderUri, liveEssentialsCreateLiveEventRequest.folderUri) &&
        Objects.equals(this.interactionToolsSettings, liveEssentialsCreateLiveEventRequest.interactionToolsSettings) &&
        Objects.equals(this.lowLatency, liveEssentialsCreateLiveEventRequest.lowLatency) &&
        Objects.equals(this.playlistSort, liveEssentialsCreateLiveEventRequest.playlistSort) &&
        Objects.equals(this.rtmpPreview, liveEssentialsCreateLiveEventRequest.rtmpPreview) &&
        Objects.equals(this.schedule, liveEssentialsCreateLiveEventRequest.schedule) &&
        Objects.equals(this.scheduledPlayback, liveEssentialsCreateLiveEventRequest.scheduledPlayback) &&
        Objects.equals(this.streamDescription, liveEssentialsCreateLiveEventRequest.streamDescription) &&
        Objects.equals(this.streamEmbed, liveEssentialsCreateLiveEventRequest.streamEmbed) &&
        Objects.equals(this.streamPassword, liveEssentialsCreateLiveEventRequest.streamPassword) &&
        Objects.equals(this.streamPrivacy, liveEssentialsCreateLiveEventRequest.streamPrivacy) &&
        Objects.equals(this.streamTitle, liveEssentialsCreateLiveEventRequest.streamTitle) &&
        Objects.equals(this.timeZone, liveEssentialsCreateLiveEventRequest.timeZone)&&
        Objects.equals(this.additionalProperties, liveEssentialsCreateLiveEventRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LiveEssentialsCreateLiveEventRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LiveEssentialsCreateLiveEventRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LiveEssentialsCreateLiveEventRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LiveEssentialsCreateLiveEventRequest is not found in the empty JSON string", LiveEssentialsCreateLiveEventRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LiveEssentialsCreateLiveEventRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("embed") != null && !jsonObj.get("embed").isJsonNull()) {
        LiveEssentialsCreateLiveEventRequestEmbed.validateJsonObject(jsonObj.getAsJsonObject("embed"));
      }
      ...
      if (jsonObj.get("interaction_tools_settings") != null && !jsonObj.get("interaction_tools_settings").isJsonNull()) {
        LiveEssentialsCreateLiveEventRequestInteractionToolsSettings.validateJsonObject(jsonObj.getAsJsonObject("interaction_tools_settings"));
      }
      ...
      if (jsonObj.get("schedule") != null && !jsonObj.get("schedule").isJsonNull()) {
        LiveEssentialsCreateLiveEventRequestSchedule.validateJsonObject(jsonObj.getAsJsonObject("schedule"));
      }
      ...
      if (jsonObj.get("stream_embed") != null && !jsonObj.get("stream_embed").isJsonNull()) {
        LiveEssentialsCreateLiveEventRequestStreamEmbed.validateJsonObject(jsonObj.getAsJsonObject("stream_embed"));
      }
      ...
      if (jsonObj.get("stream_privacy") != null && !jsonObj.get("stream_privacy").isJsonNull()) {
        LiveEssentialsCreateLiveEventRequestStreamPrivacy.validateJsonObject(jsonObj.getAsJsonObject("stream_privacy"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LiveEssentialsCreateLiveEventRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LiveEssentialsCreateLiveEventRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LiveEssentialsCreateLiveEventRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LiveEssentialsCreateLiveEventRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<LiveEssentialsCreateLiveEventRequest>() {
           @Override
           public void write(JsonWriter out, LiveEssentialsCreateLiveEventRequest value) throws IOException {
           ...
           @Override
           public LiveEssentialsCreateLiveEventRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LiveEssentialsCreateLiveEventRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LiveEssentialsCreateLiveEventRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LiveEssentialsCreateLiveEventRequest
  * @throws IOException if the JSON string is invalid with respect to LiveEssentialsCreateLiveEventRequest
  */
  public static LiveEssentialsCreateLiveEventRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LiveEssentialsCreateLiveEventRequest.class);
  }

 /**
  * Convert an instance of LiveEssentialsCreateLiveEventRequest to an JSON string
  *
  * @return JSON string
  */
