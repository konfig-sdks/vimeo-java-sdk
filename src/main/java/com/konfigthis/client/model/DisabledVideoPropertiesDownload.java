 ...
 */
@ApiModel(description = "An object that represents the reason why download is disabled for the video.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class DisabledVideoPropertiesDownload {
 ...
 public enum MinTierForCapabilityEnum {
  ...
  private List<DisabledVideoPropertiesDownloadReasonsInner> reasons = new ArrayList<>();

  public DisabledVideoPropertiesDownload() {
  }

  public DisabledVideoPropertiesDownload enableLink(String enableLink) {
  ...
  **/
  ...
  @ApiModelProperty(example = "/store/pro", required = true, value = "The relative link to upgrade downloads.")
  ...
  public DisabledVideoPropertiesDownload keyPath(String keyPath) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The path to the download object in the video response.")
  ...
  public DisabledVideoPropertiesDownload minTierForCapability(MinTierForCapabilityEnum minTierForCapability) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "PRO", required = true, value = "The capability required to activate downloads.  Option descriptions:  * `basic` - The user must have at least a Vimeo Basic account.  * `business` - The user must have at least a Vimeo Business account.  * `enterprise` - The user must have at least a Vimeo Enterprise account.  * `live_business` - The user must have at least a Vimeo Business Live account.  * `live_premium` - The user must have at least a Vimeo Premium account.  * `live_pro` - The user must have at least a Vimeo Pro Live account.  * `plus` - The user must have at least a Vimeo Plus account.  * `pro` - The user must have at least a Vimeo Pro account.  * `pro_unlimited` - The user must have at least a Vimeo Pro Unlimited account.  * `producer` - The user must have at least a Vimeo Producer account. ")
  ...
  public DisabledVideoPropertiesDownload reasons(List<DisabledVideoPropertiesDownloadReasonsInner> reasons) {
  ...
  public DisabledVideoPropertiesDownload addReasonsItem(DisabledVideoPropertiesDownloadReasonsInner reasonsItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The reasons why download is disabled for the video.")

  public List<DisabledVideoPropertiesDownloadReasonsInner> getReasons() {
    return reasons;
  }


  public void setReasons(List<DisabledVideoPropertiesDownloadReasonsInner> reasons) {
   ...
   * @return the DisabledVideoPropertiesDownload instance itself
   */
  public DisabledVideoPropertiesDownload putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DisabledVideoPropertiesDownload disabledVideoPropertiesDownload = (DisabledVideoPropertiesDownload) o;
    return Objects.equals(this.enableLink, disabledVideoPropertiesDownload.enableLink) &&
        Objects.equals(this.keyPath, disabledVideoPropertiesDownload.keyPath) &&
        Objects.equals(this.minTierForCapability, disabledVideoPropertiesDownload.minTierForCapability) &&
        Objects.equals(this.reasons, disabledVideoPropertiesDownload.reasons)&&
        Objects.equals(this.additionalProperties, disabledVideoPropertiesDownload.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DisabledVideoPropertiesDownload {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DisabledVideoPropertiesDownload
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DisabledVideoPropertiesDownload.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisabledVideoPropertiesDownload is not found in the empty JSON string", DisabledVideoPropertiesDownload.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DisabledVideoPropertiesDownload.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayreasons.size(); i++) {
        DisabledVideoPropertiesDownloadReasonsInner.validateJsonObject(jsonArrayreasons.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisabledVideoPropertiesDownload.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisabledVideoPropertiesDownload' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisabledVideoPropertiesDownload> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisabledVideoPropertiesDownload.class));

       return (TypeAdapter<T>) new TypeAdapter<DisabledVideoPropertiesDownload>() {
           @Override
           public void write(JsonWriter out, DisabledVideoPropertiesDownload value) throws IOException {
           ...
           @Override
           public DisabledVideoPropertiesDownload read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DisabledVideoPropertiesDownload instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DisabledVideoPropertiesDownload given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DisabledVideoPropertiesDownload
  * @throws IOException if the JSON string is invalid with respect to DisabledVideoPropertiesDownload
  */
  public static DisabledVideoPropertiesDownload fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DisabledVideoPropertiesDownload.class);
  }

 /**
  * Convert an instance of DisabledVideoPropertiesDownload to an JSON string
  *
  * @return JSON string
  */
