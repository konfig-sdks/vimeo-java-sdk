...
public class LiveEventAutomatedClosedCaptionsEditPreferenceRequest {
 ...
 public enum AutoCcLangEnum {
  ...
  public LiveEventAutomatedClosedCaptionsEditPreferenceRequest() {
  }

  public LiveEventAutomatedClosedCaptionsEditPreferenceRequest autoCcEnabled(Boolean autoCcEnabled) {
  ...
  **/
  ...
  public LiveEventAutomatedClosedCaptionsEditPreferenceRequest autoCcKeywords(String autoCcKeywords) {
  ...
  **/
  ...
  public LiveEventAutomatedClosedCaptionsEditPreferenceRequest autoCcLang(AutoCcLangEnum autoCcLang) {
  ...
  **/
   ...
   * @return the LiveEventAutomatedClosedCaptionsEditPreferenceRequest instance itself
   */
  public LiveEventAutomatedClosedCaptionsEditPreferenceRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LiveEventAutomatedClosedCaptionsEditPreferenceRequest liveEventAutomatedClosedCaptionsEditPreferenceRequest = (LiveEventAutomatedClosedCaptionsEditPreferenceRequest) o;
    return Objects.equals(this.autoCcEnabled, liveEventAutomatedClosedCaptionsEditPreferenceRequest.autoCcEnabled) &&
        Objects.equals(this.autoCcKeywords, liveEventAutomatedClosedCaptionsEditPreferenceRequest.autoCcKeywords) &&
        Objects.equals(this.autoCcLang, liveEventAutomatedClosedCaptionsEditPreferenceRequest.autoCcLang)&&
        Objects.equals(this.additionalProperties, liveEventAutomatedClosedCaptionsEditPreferenceRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LiveEventAutomatedClosedCaptionsEditPreferenceRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LiveEventAutomatedClosedCaptionsEditPreferenceRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LiveEventAutomatedClosedCaptionsEditPreferenceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LiveEventAutomatedClosedCaptionsEditPreferenceRequest is not found in the empty JSON string", LiveEventAutomatedClosedCaptionsEditPreferenceRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LiveEventAutomatedClosedCaptionsEditPreferenceRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LiveEventAutomatedClosedCaptionsEditPreferenceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LiveEventAutomatedClosedCaptionsEditPreferenceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LiveEventAutomatedClosedCaptionsEditPreferenceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LiveEventAutomatedClosedCaptionsEditPreferenceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<LiveEventAutomatedClosedCaptionsEditPreferenceRequest>() {
           @Override
           public void write(JsonWriter out, LiveEventAutomatedClosedCaptionsEditPreferenceRequest value) throws IOException {
           ...
           @Override
           public LiveEventAutomatedClosedCaptionsEditPreferenceRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LiveEventAutomatedClosedCaptionsEditPreferenceRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LiveEventAutomatedClosedCaptionsEditPreferenceRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LiveEventAutomatedClosedCaptionsEditPreferenceRequest
  * @throws IOException if the JSON string is invalid with respect to LiveEventAutomatedClosedCaptionsEditPreferenceRequest
  */
  public static LiveEventAutomatedClosedCaptionsEditPreferenceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LiveEventAutomatedClosedCaptionsEditPreferenceRequest.class);
  }

 /**
  * Convert an instance of LiveEventAutomatedClosedCaptionsEditPreferenceRequest to an JSON string
  *
  * @return JSON string
  */
