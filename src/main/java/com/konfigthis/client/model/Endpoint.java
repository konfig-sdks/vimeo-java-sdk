...
public class Endpoint {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "All HTTP methods permitted on this endpoint.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "/me", required = true, value = "The path section of the URL, which, when appended to the API host `https:///api.vimeo.com`, builds a full API endpoint.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(methods, path, additionalProperties);
  }
