 ...
 */
@ApiModel(description = "Metadata about the group.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class GroupMetadata {
  public static final String SERIALIZED_NAME_CONNECTIONS = "connections";
  @SerializedName(SERIALIZED_NAME_CONNECTIONS)
  private GroupMetadataConnections connections;

  public static final String SERIALIZED_NAME_INTERACTIONS = "interactions";
  @SerializedName(SERIALIZED_NAME_INTERACTIONS)
  private GroupMetadataInteractions interactions;

  public GroupMetadata() {
  }

  public GroupMetadata connections(GroupMetadataConnections connections) {
  ...
  **/
  ...
  public GroupMetadataConnections getConnections() {
    return connections;
  }


  public void setConnections(GroupMetadataConnections connections) {
  ...
  public GroupMetadata interactions(GroupMetadataInteractions interactions) {
  ...
  **/
  ...
  public GroupMetadataInteractions getInteractions() {
    return interactions;
  }


  public void setInteractions(GroupMetadataInteractions interactions) {
   ...
   * @return the GroupMetadata instance itself
   */
  public GroupMetadata putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.connections, groupMetadata.connections) &&
        Objects.equals(this.interactions, groupMetadata.interactions)&&
        Objects.equals(this.additionalProperties, groupMetadata.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GroupMetadata
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GroupMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      GroupMetadataConnections.validateJsonObject(jsonObj.getAsJsonObject("connections"));
      // validate the required field `interactions`
      GroupMetadataInteractions.validateJsonObject(jsonObj.getAsJsonObject("interactions"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GroupMetadata>() {
           ...
           public GroupMetadata read(JsonReader in) throws IOException {
             ...
             GroupMetadata instance = thisAdapter.fromJsonTree(jsonObj);
