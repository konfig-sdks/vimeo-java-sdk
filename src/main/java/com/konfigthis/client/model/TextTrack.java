...
public class TextTrack {
  ...
  public static final String SERIALIZED_NAME_DISPLAY_LANGUAGE = "display_language";
  ...
  **/
  ...
  @ApiModelProperty(example = "true", required = true, value = "Whether the text track is active.")
  ...
  public TextTrack displayLanguage(String displayLanguage) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "English (United States)", required = true, value = "The name of the language.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The read-only URL of the text track file, intended for use with HLS playback.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "1494888499", required = true, value = "The time in ISO 8601 format when the read-only HLS playback text track file expires.")
  ...
  public TextTrack id(Integer id) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "12345", required = true, value = "The text track identifier.")
  ...
  **/
  ...
  @ApiModelProperty(example = "en-US", required = true, value = "The language code for the text track. To see a full list, request `/languages?filter=texttrack`.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The read-only URL of the text track file. You can upload to this link when you create it for the first time.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "1494888499", required = true, value = "The time in ISO 8601 format when the text track link expires.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "English Subtitles", required = true, value = "The descriptive name of the text track.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "CAPTIONS", required = true, value = "The type of text track.  Option descriptions:  * `captions` - The text track is for captions.  * `subtitles` - The text track is for subtitles. ")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "/videos/258684937/texttracks/12345", required = true, value = "The relative URI of the text track.")
   ...
   * @return the TextTrack instance itself
   */
  public TextTrack putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.active, textTrack.active) &&
        ...
        Objects.equals(this.additionalProperties, textTrack.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(active, displayLanguage, hlsLink, hlsLinkExpiresTime, id, language, link, linkExpiresTime, name, type, uri, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("display_language");
    ...
    openapiRequiredFields.add("display_language");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TextTrack
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TextTrack.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (!jsonObj.get("display_language").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `display_language` to be a primitive type in the JSON string but got `%s`", jsonObj.get("display_language").toString()));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TextTrack>() {
           ...
           public TextTrack read(JsonReader in) throws IOException {
             ...
             TextTrack instance = thisAdapter.fromJsonTree(jsonObj);
