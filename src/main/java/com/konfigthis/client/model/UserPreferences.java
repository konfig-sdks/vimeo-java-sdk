...
public class UserPreferences {
  ...
  **/
   ...
   * @return the UserPreferences instance itself
   */
  public UserPreferences putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.videos, userPreferences.videos)&&
        Objects.equals(this.additionalProperties, userPreferences.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UserPreferences
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UserPreferences.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : UserPreferences.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `videos`
      UserPreferencesVideos.validateJsonObject(jsonObj.getAsJsonObject("videos"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UserPreferences>() {
           ...
           public UserPreferences read(JsonReader in) throws IOException {
             ...
             UserPreferences instance = thisAdapter.fromJsonTree(jsonObj);
