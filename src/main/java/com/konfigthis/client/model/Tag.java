...
import com.konfigthis.client.model.TagMetadata;
...
public class Tag {
  ...
  **/
  ...
  @ApiModelProperty(example = "awesome", required = true, value = "The normalized canonical tag name.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "awesome", required = true, value = "The tag value.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "bac1033deba2310ebba2caec33c23e4beea67aba", required = true, value = "The tag's resource key string.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "/videos/258684937/tags/awesome", required = true, value = "The canonical relative URI of the tag.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(canonical, metadata, name, resourceKey, uri, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      TagMetadata.validateJsonObject(jsonObj.getAsJsonObject("metadata"));
