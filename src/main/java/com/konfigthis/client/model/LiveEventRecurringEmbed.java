...
import com.konfigthis.client.model.LiveEventRecurringEmbedColors;
import com.konfigthis.client.model.LiveEventRecurringEmbedLogos;
...
public class LiveEventRecurringEmbed {
  ...
  private LiveEventRecurringEmbedColors colors;
  ...
  private LiveEventRecurringEmbedLogos logos;
 ...
 public enum PlayButtonPositionEnum {
  ...
  public LiveEventRecurringEmbed() {
  }

  public LiveEventRecurringEmbed title(Boolean title) {
  ...
  **/
  ...
  public LiveEventRecurringEmbed airplay(Boolean airplay) {
  ...
  **/
  ...
  public LiveEventRecurringEmbed autoplay(Boolean autoplay) {
  ...
  **/
  ...
  public LiveEventRecurringEmbed availablePlayerLogos(List<String> availablePlayerLogos) {
  ...
  public LiveEventRecurringEmbed addAvailablePlayerLogosItem(String availablePlayerLogosItem) {
  ...
  **/
  ...
  public LiveEventRecurringEmbed byline(Boolean byline) {
  ...
  **/
  ...
  public LiveEventRecurringEmbed chatEmbedSource(String chatEmbedSource) {
  ...
  **/
  ...
  public LiveEventRecurringEmbed chromecast(Boolean chromecast) {
  ...
  **/
  ...
  public LiveEventRecurringEmbed closedCaptions(Boolean closedCaptions) {
  ...
  **/
  ...
  public LiveEventRecurringEmbed color(String color) {
  ...
  **/
  ...
  public LiveEventRecurringEmbed colors(LiveEventRecurringEmbedColors colors) {
  ...
  **/
  ...
  public LiveEventRecurringEmbedColors getColors() {
    return colors;
  }


  public void setColors(LiveEventRecurringEmbedColors colors) {
  ...
  public LiveEventRecurringEmbed embedChat(String embedChat) {
  ...
  **/
  ...
  public LiveEventRecurringEmbed embedProperties(LiveEventEmbedEmbedProperties embedProperties) {
  ...
  **/
  ...
  public LiveEventRecurringEmbed eventSchedule(Boolean eventSchedule) {
  ...
  **/
  ...
  public LiveEventRecurringEmbed fullscreenButton(Boolean fullscreenButton) {
  ...
  **/
  ...
  public LiveEventRecurringEmbed hideLiveLabel(Boolean hideLiveLabel) {
  ...
  **/
  ...
  public LiveEventRecurringEmbed hideViewerCount(Boolean hideViewerCount) {
  ...
  **/
  ...
  public LiveEventRecurringEmbed html(String html) {
  ...
  **/
  ...
  public LiveEventRecurringEmbed likeButton(Boolean likeButton) {
  ...
  **/
  ...
  public LiveEventRecurringEmbed logos(LiveEventRecurringEmbedLogos logos) {
  ...
  **/
  ...
  public LiveEventRecurringEmbedLogos getLogos() {
    return logos;
  }


  public void setLogos(LiveEventRecurringEmbedLogos logos) {
  ...
  public LiveEventRecurringEmbed loop(Boolean loop) {
  ...
  **/
  ...
  public LiveEventRecurringEmbed pip(Boolean pip) {
  ...
  **/
  ...
  public LiveEventRecurringEmbed playButtonPosition(PlayButtonPositionEnum playButtonPosition) {
  ...
  **/
  ...
  public LiveEventRecurringEmbed playbar(Boolean playbar) {
  ...
  **/
  ...
  public LiveEventRecurringEmbed playlist(Boolean playlist) {
  ...
  **/
  ...
  public LiveEventRecurringEmbed portrait(Boolean portrait) {
  ...
  **/
  ...
  public LiveEventRecurringEmbed responsiveHtml(String responsiveHtml) {
  ...
  **/
  ...
  public LiveEventRecurringEmbed schedule(Boolean schedule) {
  ...
  **/
  ...
  public LiveEventRecurringEmbed showLatestArchivedClip(Boolean showLatestArchivedClip) {
  ...
  **/
  ...
  public LiveEventRecurringEmbed showTimezone(Boolean showTimezone) {
  ...
  **/
  ...
  public LiveEventRecurringEmbed useColor(String useColor) {
  ...
  **/
  ...
  public LiveEventRecurringEmbed volume(Boolean volume) {
  ...
  **/
   ...
   * @return the LiveEventRecurringEmbed instance itself
   */
  public LiveEventRecurringEmbed putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LiveEventRecurringEmbed liveEventRecurringEmbed = (LiveEventRecurringEmbed) o;
    return Objects.equals(this.title, liveEventRecurringEmbed.title) &&
        Objects.equals(this.airplay, liveEventRecurringEmbed.airplay) &&
        Objects.equals(this.autoplay, liveEventRecurringEmbed.autoplay) &&
        Objects.equals(this.availablePlayerLogos, liveEventRecurringEmbed.availablePlayerLogos) &&
        Objects.equals(this.byline, liveEventRecurringEmbed.byline) &&
        Objects.equals(this.chatEmbedSource, liveEventRecurringEmbed.chatEmbedSource) &&
        Objects.equals(this.chromecast, liveEventRecurringEmbed.chromecast) &&
        Objects.equals(this.closedCaptions, liveEventRecurringEmbed.closedCaptions) &&
        Objects.equals(this.color, liveEventRecurringEmbed.color) &&
        Objects.equals(this.colors, liveEventRecurringEmbed.colors) &&
        Objects.equals(this.embedChat, liveEventRecurringEmbed.embedChat) &&
        Objects.equals(this.embedProperties, liveEventRecurringEmbed.embedProperties) &&
        Objects.equals(this.eventSchedule, liveEventRecurringEmbed.eventSchedule) &&
        Objects.equals(this.fullscreenButton, liveEventRecurringEmbed.fullscreenButton) &&
        Objects.equals(this.hideLiveLabel, liveEventRecurringEmbed.hideLiveLabel) &&
        Objects.equals(this.hideViewerCount, liveEventRecurringEmbed.hideViewerCount) &&
        Objects.equals(this.html, liveEventRecurringEmbed.html) &&
        Objects.equals(this.likeButton, liveEventRecurringEmbed.likeButton) &&
        Objects.equals(this.logos, liveEventRecurringEmbed.logos) &&
        Objects.equals(this.loop, liveEventRecurringEmbed.loop) &&
        Objects.equals(this.pip, liveEventRecurringEmbed.pip) &&
        Objects.equals(this.playButtonPosition, liveEventRecurringEmbed.playButtonPosition) &&
        Objects.equals(this.playbar, liveEventRecurringEmbed.playbar) &&
        Objects.equals(this.playlist, liveEventRecurringEmbed.playlist) &&
        Objects.equals(this.portrait, liveEventRecurringEmbed.portrait) &&
        Objects.equals(this.responsiveHtml, liveEventRecurringEmbed.responsiveHtml) &&
        Objects.equals(this.schedule, liveEventRecurringEmbed.schedule) &&
        Objects.equals(this.showLatestArchivedClip, liveEventRecurringEmbed.showLatestArchivedClip) &&
        Objects.equals(this.showTimezone, liveEventRecurringEmbed.showTimezone) &&
        Objects.equals(this.useColor, liveEventRecurringEmbed.useColor) &&
        Objects.equals(this.volume, liveEventRecurringEmbed.volume)&&
        Objects.equals(this.additionalProperties, liveEventRecurringEmbed.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LiveEventRecurringEmbed {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LiveEventRecurringEmbed
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LiveEventRecurringEmbed.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LiveEventRecurringEmbed is not found in the empty JSON string", LiveEventRecurringEmbed.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LiveEventRecurringEmbed.openapiRequiredFields) {
      ...
      LiveEventRecurringEmbedColors.validateJsonObject(jsonObj.getAsJsonObject("colors"));
      ...
      LiveEventRecurringEmbedLogos.validateJsonObject(jsonObj.getAsJsonObject("logos"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LiveEventRecurringEmbed.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LiveEventRecurringEmbed' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LiveEventRecurringEmbed> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LiveEventRecurringEmbed.class));

       return (TypeAdapter<T>) new TypeAdapter<LiveEventRecurringEmbed>() {
           @Override
           public void write(JsonWriter out, LiveEventRecurringEmbed value) throws IOException {
           ...
           @Override
           public LiveEventRecurringEmbed read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LiveEventRecurringEmbed instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LiveEventRecurringEmbed given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LiveEventRecurringEmbed
  * @throws IOException if the JSON string is invalid with respect to LiveEventRecurringEmbed
  */
  public static LiveEventRecurringEmbed fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LiveEventRecurringEmbed.class);
  }

 /**
  * Convert an instance of LiveEventRecurringEmbed to an JSON string
  *
  * @return JSON string
  */
