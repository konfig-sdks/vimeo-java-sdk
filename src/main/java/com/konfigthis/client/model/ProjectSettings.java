 ...
 */
@ApiModel(description = "The settings of the folder.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ProjectSettings {
  ...
  public ProjectSettings color(String color) {
  ...
  **/
  ...
  @ApiModelProperty(example = "#c0c0c0", required = true, value = "The hexadecimal code of the folder color.")
  ...
  public ProjectSettings folderUri(String folderUri) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.color, projectSettings.color) &&
        Objects.equals(this.folderUri, projectSettings.folderUri)&&
        Objects.equals(this.additionalProperties, projectSettings.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(color, folderUri, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (!jsonObj.get("folder_uri").isJsonNull() && !jsonObj.get("folder_uri").isJsonPrimitive()) {
