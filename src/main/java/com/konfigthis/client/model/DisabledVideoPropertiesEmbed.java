...
import com.konfigthis.client.model.DisabledVideoPropertiesEmbedReasonsInner;
 ...
 */
@ApiModel(description = "An object that represents the reason why embed is disabled for the video.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class DisabledVideoPropertiesEmbed {
 ...
 public enum MinTierForCapabilityEnum {
  ...
  private List<DisabledVideoPropertiesEmbedReasonsInner> reasons = new ArrayList<>();

  public DisabledVideoPropertiesEmbed() {
  }

  public DisabledVideoPropertiesEmbed enableLink(String enableLink) {
  ...
  **/
  ...
  @ApiModelProperty(example = "/store/pro", required = true, value = "The relative link to upgrade embeds.")
  ...
  public DisabledVideoPropertiesEmbed keyPath(String keyPath) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The path to the embed object in the video response.")
  ...
  public DisabledVideoPropertiesEmbed minTierForCapability(MinTierForCapabilityEnum minTierForCapability) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "PRO", required = true, value = "The capability required to activate embeds.  Option descriptions:  * `basic` - The user must have at least a Vimeo Basic account.  * `business` - The user must have at least a Vimeo Business account.  * `enterprise` - The user must have at least a Vimeo Enterprise account.  * `live_business` - The user must have at least a Vimeo Business Live account.  * `live_premium` - The user must have at least a Vimeo Premium account.  * `live_pro` - The user must have at least a Vimeo Pro Live account.  * `plus` - The user must have at least a Vimeo Plus account.  * `pro` - The user must have at least a Vimeo Pro account.  * `pro_unlimited` - The user must have at least a Vimeo Pro Unlimited account.  * `producer` - The user must have at least a Vimeo Producer account. ")
  ...
  public DisabledVideoPropertiesEmbed reasons(List<DisabledVideoPropertiesEmbedReasonsInner> reasons) {
  ...
  public DisabledVideoPropertiesEmbed addReasonsItem(DisabledVideoPropertiesEmbedReasonsInner reasonsItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The reasons why embed is disabled for the video.")

  public List<DisabledVideoPropertiesEmbedReasonsInner> getReasons() {
    return reasons;
  }


  public void setReasons(List<DisabledVideoPropertiesEmbedReasonsInner> reasons) {
   ...
   * @return the DisabledVideoPropertiesEmbed instance itself
   */
  public DisabledVideoPropertiesEmbed putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DisabledVideoPropertiesEmbed disabledVideoPropertiesEmbed = (DisabledVideoPropertiesEmbed) o;
    return Objects.equals(this.enableLink, disabledVideoPropertiesEmbed.enableLink) &&
        Objects.equals(this.keyPath, disabledVideoPropertiesEmbed.keyPath) &&
        Objects.equals(this.minTierForCapability, disabledVideoPropertiesEmbed.minTierForCapability) &&
        Objects.equals(this.reasons, disabledVideoPropertiesEmbed.reasons)&&
        Objects.equals(this.additionalProperties, disabledVideoPropertiesEmbed.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DisabledVideoPropertiesEmbed {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DisabledVideoPropertiesEmbed
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DisabledVideoPropertiesEmbed.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisabledVideoPropertiesEmbed is not found in the empty JSON string", DisabledVideoPropertiesEmbed.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DisabledVideoPropertiesEmbed.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayreasons.size(); i++) {
        DisabledVideoPropertiesEmbedReasonsInner.validateJsonObject(jsonArrayreasons.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisabledVideoPropertiesEmbed.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisabledVideoPropertiesEmbed' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisabledVideoPropertiesEmbed> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisabledVideoPropertiesEmbed.class));

       return (TypeAdapter<T>) new TypeAdapter<DisabledVideoPropertiesEmbed>() {
           @Override
           public void write(JsonWriter out, DisabledVideoPropertiesEmbed value) throws IOException {
           ...
           @Override
           public DisabledVideoPropertiesEmbed read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DisabledVideoPropertiesEmbed instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DisabledVideoPropertiesEmbed given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DisabledVideoPropertiesEmbed
  * @throws IOException if the JSON string is invalid with respect to DisabledVideoPropertiesEmbed
  */
  public static DisabledVideoPropertiesEmbed fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DisabledVideoPropertiesEmbed.class);
  }

 /**
  * Convert an instance of DisabledVideoPropertiesEmbed to an JSON string
  *
  * @return JSON string
  */
