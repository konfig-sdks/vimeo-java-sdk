...
public class OnDemandVideo {
  ...
  **/
  ...
  @ApiModelProperty(example = "This video provides in-depth instruction in the use of the Vimeo API.", value = "The description of the video.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1197", value = "The duration of the video.")
  ...
  public OnDemandVideo episode(Double episode) {
  ...
  public OnDemandVideo episode(Integer episode) {
    
    
    
    
    this.episode = episode.doubleValue();
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1", value = "The episode number of the video.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "https://vimeo.com/ondemand/darbyforever/12345", required = true, value = "The link to the video on Vimeo.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Darby Forever", value = "The title of the video.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The active picture of the video.")
  ...
  public OnDemandVideo playProgress(Double playProgress) {
  ...
  public OnDemandVideo playProgress(Integer playProgress) {
    
    
    
    
    this.playProgress = playProgress.doubleValue();
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "30", required = true, value = "The authenticated user's most recent play position in the video, in seconds.")
  ...
  public OnDemandVideo position(Double position) {
  ...
  public OnDemandVideo position(Integer position) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1", value = "The position of the video relative to the other videos on the On Demand page.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2017-05-12T21:06:42+00:00", value = "The time in ISO 8601 format when the video was created or published.")
  ...
  public OnDemandVideo releaseYear(Double releaseYear) {
  ...
  public OnDemandVideo releaseYear(Integer releaseYear) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2016", required = true, value = "The year that the video was released.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "MAIN", required = true, value = "The type of video.  Option descriptions:  * `extra` - The video is an extra feature.  * `main` - The video is a main feature.  * `trailer` - The video is a trailer. ")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "/ondemand/pages/61326/videos/12345", required = true, value = "The video container's relative URI.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The owner of the video.")
   ...
   * @return the OnDemandVideo instance itself
   */
  public OnDemandVideo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, onDemandVideo.description) &&
        Objects.equals(this.buy, onDemandVideo.buy) &&
        ...
        Objects.equals(this.additionalProperties, onDemandVideo.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, buy, duration, episode, interactions, link, metadata, name, options, pictures, playProgress, position, releaseDate, releaseYear, rent, type, uri, user, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to OnDemandVideo
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OnDemandVideo.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      OnDemandVideoBuy.validateJsonObject(jsonObj.getAsJsonObject("buy"));
      if ((jsonObj.get("duration") != null && !jsonObj.get("duration").isJsonNull()) && !jsonObj.get("duration").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `duration` to be a primitive type in the JSON string but got `%s`", jsonObj.get("duration").toString()));
      }
      // validate the required field `interactions`
      OnDemandVideoInteractions.validateJsonObject(jsonObj.getAsJsonObject("interactions"));
      if (!jsonObj.get("link").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `link` to be a primitive type in the JSON string but got `%s`", jsonObj.get("link").toString()));
      }
      // validate the required field `metadata`
      OnDemandVideoMetadata.validateJsonObject(jsonObj.getAsJsonObject("metadata"));
      ...
      OnDemandVideoRent.validateJsonObject(jsonObj.getAsJsonObject("rent"));
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OnDemandVideo>() {
           ...
           public OnDemandVideo read(JsonReader in) throws IOException {
             ...
             OnDemandVideo instance = thisAdapter.fromJsonTree(jsonObj);
