...
public class CreateVodRequestRentPrice {
  ...
  public CreateVodRequestRentPrice() {
  }

  public CreateVodRequestRentPrice AUD(Double AUD) {
  ...
  public CreateVodRequestRentPrice AUD(Integer AUD) {
  ...
  **/
  ...
  public CreateVodRequestRentPrice CAD(Double CAD) {
  ...
  public CreateVodRequestRentPrice CAD(Integer CAD) {
  ...
  **/
  ...
  public CreateVodRequestRentPrice CHF(Double CHF) {
  ...
  public CreateVodRequestRentPrice CHF(Integer CHF) {
  ...
  **/
  ...
  public CreateVodRequestRentPrice DKK(Double DKK) {
  ...
  public CreateVodRequestRentPrice DKK(Integer DKK) {
  ...
  **/
  ...
  public CreateVodRequestRentPrice EUR(Double EUR) {
  ...
  public CreateVodRequestRentPrice EUR(Integer EUR) {
  ...
  **/
  ...
  public CreateVodRequestRentPrice GBP(Double GBP) {
  ...
  public CreateVodRequestRentPrice GBP(Integer GBP) {
  ...
  **/
  ...
  public CreateVodRequestRentPrice JPY(Double JPY) {
  ...
  public CreateVodRequestRentPrice JPY(Integer JPY) {
  ...
  **/
  ...
  public CreateVodRequestRentPrice KRW(Double KRW) {
  ...
  public CreateVodRequestRentPrice KRW(Integer KRW) {
  ...
  **/
  ...
  public CreateVodRequestRentPrice NOK(Double NOK) {
  ...
  public CreateVodRequestRentPrice NOK(Integer NOK) {
  ...
  **/
  ...
  public CreateVodRequestRentPrice PLN(Double PLN) {
  ...
  public CreateVodRequestRentPrice PLN(Integer PLN) {
  ...
  **/
  ...
  public CreateVodRequestRentPrice SEK(Double SEK) {
  ...
  public CreateVodRequestRentPrice SEK(Integer SEK) {
  ...
  **/
  ...
  public CreateVodRequestRentPrice USD(Double USD) {
  ...
  public CreateVodRequestRentPrice USD(Integer USD) {
  ...
  **/
   ...
   * @return the CreateVodRequestRentPrice instance itself
   */
  public CreateVodRequestRentPrice putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreateVodRequestRentPrice createVodRequestRentPrice = (CreateVodRequestRentPrice) o;
    return Objects.equals(this.AUD, createVodRequestRentPrice.AUD) &&
        Objects.equals(this.CAD, createVodRequestRentPrice.CAD) &&
        Objects.equals(this.CHF, createVodRequestRentPrice.CHF) &&
        Objects.equals(this.DKK, createVodRequestRentPrice.DKK) &&
        Objects.equals(this.EUR, createVodRequestRentPrice.EUR) &&
        Objects.equals(this.GBP, createVodRequestRentPrice.GBP) &&
        Objects.equals(this.JPY, createVodRequestRentPrice.JPY) &&
        Objects.equals(this.KRW, createVodRequestRentPrice.KRW) &&
        Objects.equals(this.NOK, createVodRequestRentPrice.NOK) &&
        Objects.equals(this.PLN, createVodRequestRentPrice.PLN) &&
        Objects.equals(this.SEK, createVodRequestRentPrice.SEK) &&
        Objects.equals(this.USD, createVodRequestRentPrice.USD)&&
        Objects.equals(this.additionalProperties, createVodRequestRentPrice.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateVodRequestRentPrice {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateVodRequestRentPrice
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateVodRequestRentPrice.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateVodRequestRentPrice is not found in the empty JSON string", CreateVodRequestRentPrice.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateVodRequestRentPrice.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateVodRequestRentPrice' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateVodRequestRentPrice> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateVodRequestRentPrice.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateVodRequestRentPrice>() {
           @Override
           public void write(JsonWriter out, CreateVodRequestRentPrice value) throws IOException {
           ...
           @Override
           public CreateVodRequestRentPrice read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CreateVodRequestRentPrice instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreateVodRequestRentPrice given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateVodRequestRentPrice
  * @throws IOException if the JSON string is invalid with respect to CreateVodRequestRentPrice
  */
  public static CreateVodRequestRentPrice fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateVodRequestRentPrice.class);
  }

 /**
  * Convert an instance of CreateVodRequestRentPrice to an JSON string
  *
  * @return JSON string
  */
