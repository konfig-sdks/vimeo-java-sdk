...
public class LiveEventStreamPrivacy {
  /**
 ...
 public enum ViewEnum {
  ...
  public LiveEventStreamPrivacy() {
  }

  public LiveEventStreamPrivacy embed(EmbedEnum embed) {
  ...
  **/
  ...
  public LiveEventStreamPrivacy unlistedHash(String unlistedHash) {
  ...
  **/
  ...
  public LiveEventStreamPrivacy view(ViewEnum view) {
  ...
  **/
   ...
   * @return the LiveEventStreamPrivacy instance itself
   */
  public LiveEventStreamPrivacy putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LiveEventStreamPrivacy liveEventStreamPrivacy = (LiveEventStreamPrivacy) o;
    return Objects.equals(this.embed, liveEventStreamPrivacy.embed) &&
        Objects.equals(this.unlistedHash, liveEventStreamPrivacy.unlistedHash) &&
        Objects.equals(this.view, liveEventStreamPrivacy.view)&&
        Objects.equals(this.additionalProperties, liveEventStreamPrivacy.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LiveEventStreamPrivacy {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LiveEventStreamPrivacy
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LiveEventStreamPrivacy.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LiveEventStreamPrivacy is not found in the empty JSON string", LiveEventStreamPrivacy.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LiveEventStreamPrivacy.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LiveEventStreamPrivacy.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LiveEventStreamPrivacy' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LiveEventStreamPrivacy> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LiveEventStreamPrivacy.class));

       return (TypeAdapter<T>) new TypeAdapter<LiveEventStreamPrivacy>() {
           @Override
           public void write(JsonWriter out, LiveEventStreamPrivacy value) throws IOException {
           ...
           @Override
           public LiveEventStreamPrivacy read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LiveEventStreamPrivacy instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LiveEventStreamPrivacy given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LiveEventStreamPrivacy
  * @throws IOException if the JSON string is invalid with respect to LiveEventStreamPrivacy
  */
  public static LiveEventStreamPrivacy fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LiveEventStreamPrivacy.class);
  }

 /**
  * Convert an instance of LiveEventStreamPrivacy to an JSON string
  *
  * @return JSON string
  */
