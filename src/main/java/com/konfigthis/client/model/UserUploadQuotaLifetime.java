 ...
 */
@ApiModel(description = "Information about the authenticated user's lifetime upload usage.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class UserUploadQuotaLifetime {
 ...
 public enum UnitEnum {
  ...
  public UserUploadQuotaLifetime free(Double free) {
  ...
  public UserUploadQuotaLifetime free(Integer free) {
  ...
  **/
  ...
  @ApiModelProperty(example = "5000000", required = true, value = "The number of bytes or videos remaining in the authenticated user's lifetime maximum.")
  ...
  public UserUploadQuotaLifetime max(Double max) {
  ...
  public UserUploadQuotaLifetime max(Integer max) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "5368709120", required = true, value = "The total number of bytes or videos that the authenticated user can upload across the lifetime of their account.")
  ...
  public UserUploadQuotaLifetime unit(UnitEnum unit) {
  ...
  **/
  ...
  public UserUploadQuotaLifetime used(Double used) {
  ...
  public UserUploadQuotaLifetime used(Integer used) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "5368704120", required = true, value = "The number of bytes or videos that the authenticated user has already uploaded against their lifetime limit.")
   ...
   * @return the UserUploadQuotaLifetime instance itself
   */
  public UserUploadQuotaLifetime putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.free, userUploadQuotaLifetime.free) &&
        ...
        Objects.equals(this.unit, userUploadQuotaLifetime.unit) &&
        Objects.equals(this.used, userUploadQuotaLifetime.used)&&
        Objects.equals(this.additionalProperties, userUploadQuotaLifetime.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(free, max, unit, used, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UserUploadQuotaLifetime
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UserUploadQuotaLifetime.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UserUploadQuotaLifetime>() {
           ...
           public UserUploadQuotaLifetime read(JsonReader in) throws IOException {
             ...
             UserUploadQuotaLifetime instance = thisAdapter.fromJsonTree(jsonObj);
